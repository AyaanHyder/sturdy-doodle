...
master = tk.Tk()  
master.title("MARKSHEET DEVELOPED BY AYAAN") 
...
tk.Label(master, text="C programming").grid(row=4, column=1) 
tk.Label(master, text="Calculus").grid(row=5, column=1) 
tk.Label(master, text="Datastructure").grid(row=6, column=1) 
...
button1=tk.Button(master, text="submit the score", bg="green", command=display) 
button1.grid(row=8, column=1) 
         
tk.Label(master, text="Total credit").grid(row=7, column=3) 
tk.Label(master, text="CGPA").grid(row=8, column=3) 
